...
from ums import create_psql_async_session
from ums.protos.ums_control import ums_control_pb2_grpc
from ums.services.repository import RoleRepo, PermissionRepo, RolePermissionRepo
from ums.utils.s3 import S3Storage
from ums.services.ums_control import UMService
from ums import RedisClient, EmailSender
from ums.utils.role import load_roles
...
async def init_role(app: FastAPI):
    ...
    roles = load_roles("ums/models/roles")
